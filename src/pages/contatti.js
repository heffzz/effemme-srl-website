    ...
    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-green-600 text-sm">Risposta immediata</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-green-600 text-sm">Messaggio veloce</div>
                </div>
              </a>
              ...
              >
                ...
                <div>
                  ...
                  <div className="text-blue-600 text-sm">Preventivo dettagliato</div>
                </div>
              </a>
            </div>
          </div>
            ...
            <div className="bg-white rounded-2xl shadow-lg p-8">
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <button
                  ...
                  className="w-full btn-primary bg-primary-600 hover:bg-primary-700 disabled:opacity-50 disabled:cursor-not-allowed"
                >
      ...
      <section className="section-padding">
        <div className="container-custom">
          ...
          <div className="bg-gray-200 rounded-2xl overflow-hidden h-96 mb-8">
            <iframe
